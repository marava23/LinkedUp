...
{
    public partial class complete_db_migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Read = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_Users_ActionByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserInterests", x => new { x.TopicId, x.UserId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserInterests_Users_TopicId",
                        column: x => x.TopicId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostIntercationId = table.Column<int>(type: "int", nullable: true),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Intercations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Intercations_Intercations_PostIntercationId",
                        column: x => x.PostIntercationId,
                        principalTable: "Intercations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Intercations_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Intercations_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Intercations_PostId",
                table: "Intercations",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_Intercations_PostIntercationId",
                table: "Intercations",
                column: "PostIntercationId");

            migrationBuilder.CreateIndex(
                name: "IX_Intercations_UserId",
                table: "Intercations",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_ActionByUserId",
                table: "Notifications",
